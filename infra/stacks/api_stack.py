    ...
    def __init__(
        ...
        **kwargs,
        ...
        for path, method in (
            ...
            ("/walkthrough-jobs", apigwv2.HttpMethod.POST),
            ("/walkthrough-jobs/{job_id}", apigwv2.HttpMethod.GET),
            ("/walkthrough-jobs/{job_id}/enrich", apigwv2.HttpMethod.POST),
            ("/walkthrough-jobs/{job_id}/enrich", apigwv2.HttpMethod.GET),
